...
export default function ClientAppointments() {
  ...
  useEffect(() => {
    let active = true;
    const refresh = () => void getClientAppointments()
      .then((appointments) => { if (active) setItems(appointments); })
