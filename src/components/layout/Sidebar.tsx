...
// Dados de exemplo — troque pelos dados reais do estabelecimento autenticado.
      ...
      <div className="border-t border-[#E4E1D8] p-3">
        <div className="rounded-lg px-1 py-1.5">
          <EstablishmentAvatar
            ...
            subtitle={CURRENT_ESTABLISHMENT.plan}
          />
        </div>
        <LogoutButton className="mt-1" onLogout={handleLogOut} />
      </div>
    </div>
  );
}
